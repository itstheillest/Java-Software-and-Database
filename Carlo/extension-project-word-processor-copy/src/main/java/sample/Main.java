...
import sample.rightButtonPanel;
...
public class Main {
    ...
    public void rightButtonAction() {
    	...
    	rightButtonPanel rightPanelObj = new rightButtonPanel(this);
    ...
    public void leftButtonAction() {
    	...
    	// leftButtonPanelFunctions leftPanelObj = new leftButtonPanelFunctions(this);
