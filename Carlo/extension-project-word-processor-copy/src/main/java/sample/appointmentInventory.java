...
public class appointmentInventory {
	    ...
	    try (PreparedStatement pstmt = connection.prepareStatement(sql);
	        ...
	        while (rs.next()) {
	            ...
	            AppointmentData appointment = new AppointmentData(
	                ...
	                rs.getString("note"),
	                rs.getString("appointment_ID") // The date recorded, not scheduled appointment, is ALSO the appointment_ID
	            );
	...
	public static void insertAppointmentInfoToDatabase(AppointmentData appointment) {
	    String sql = "INSERT INTO appointment_inventory (last_name, first_name, middle_name, appointment_type, appointment_date, note, appointment_ID) VALUES (?, ?, ?, ?, ?, ?, ?)";
	    ...
	    try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
	        ...
	        pstmt.setString(7, appointment.getId());
